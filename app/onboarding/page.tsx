            ...
            {STEPS.map((label, idx) => (
                <div key={idx} className="flex items-center gap-2">
                    <div className="flex flex-col items-center">
                        <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold transition-all duration-300 ${idx < currentStep ? 'bg-green-400 text-white'
                                : idx === currentStep ? 'bg-purple-500 text-white shadow-lg scale-110'
                                    : 'bg-gray-200 text-gray-400'
                            }`}>
                            {idx < currentStep ? '✓' : idx + 1}
                        </div>
                        <span className={`text-xs mt-1 ${idx === currentStep ? 'text-purple-600 font-semibold' : 'text-gray-400'}`}>
                            {label}
                        </span>
                    </div>
                    {idx < STEPS.length - 1 && (
    ...
    const renderStep0 = () => (
        <div className="space-y-5">
            ...
            <button
                ...
                className="w-full flex items-center justify-center gap-3 py-3.5 rounded-xl border-2 border-gray-200 bg-white hover:bg-gray-50 active:scale-95 transition-all duration-200 text-gray-700 font-semibold"
            >
            ...
            <button
                ...
                className="w-full flex items-center justify-center gap-3 py-3.5 rounded-xl bg-[#06C755] hover:bg-[#05a847] active:scale-95 transition-all duration-200 text-white font-semibold"
            >
            ...
            {!emailSent ? (
                <div className="space-y-3">
                    ...
                    <button
                        ...
                        className="w-full py-3.5 rounded-xl bg-blue-600 hover:bg-blue-700 active:scale-95 transition-all text-white font-bold disabled:opacity-50 disabled:cursor-not-allowed"
                    >
        ...
        <div className="min-h-screen bg-gradient-to-b from-purple-50 via-pink-50 to-blue-50 flex items-center justify-center p-4">
            <div className="w-full max-w-md">
                <div className="text-center mb-6">
                    ...
                    <p className="text-xs text-gray-400 mt-1">はじめてのセットアップ</p>
                </div>

                <div className="bg-white rounded-3xl shadow-xl p-6 sm:p-8">
                    {currentStep < 2 && <StepIndicator />}
